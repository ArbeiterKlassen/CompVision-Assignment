// MFC_PicViewer_OptionDlg.cpp: 实现文件
//
...
IMPLEMENT_DYNAMIC(MFC_PicViewer_OptionDlg, CDialogEx)

MFC_PicViewer_OptionDlg::MFC_PicViewer_OptionDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_DIALOG1, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

//MFC_PicViewer_OptionDlg::~MFC_PicViewer_OptionDlg()
//{
//
//}

void MFC_PicViewer_OptionDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_BUTTON101, m_btnMax);
	DDX_Control(pDX, IDC_BUTTON102, m_btnMin);
	DDX_Control(pDX, IDC_BUTTON103, m_btnExit);
}


BEGIN_MESSAGE_MAP(MFC_PicViewer_OptionDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_NCHITTEST()
	ON_WM_QUERYDRAGICON()
	ON_WM_CTLCOLOR()
	ON_WM_SIZE()
	ON_BN_CLICKED(IDC_BUTTON101, &MFC_PicViewer_OptionDlg::OnBnClickedButton101)
	ON_BN_CLICKED(IDC_BUTTON102, &MFC_PicViewer_OptionDlg::OnBnClickedButton102)
	ON_BN_CLICKED(IDC_BUTTON103, &MFC_PicViewer_OptionDlg::OnBnClickedButton103)
END_MESSAGE_MAP()


// MFC_PicViewer_OptionDlg 消息处理程序
BOOL MFC_PicViewer_OptionDlg::OnInitDialog()
{
...
void MFC_PicViewer_OptionDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void MFC_PicViewer_OptionDlg::OnPaint()
{
	if (IsIconic())
	{
...
//显示。
HCURSOR MFC_PicViewer_OptionDlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}

LRESULT MFC_PicViewer_OptionDlg::OnNcHitTest(CPoint point)
{
...
void MFC_PicViewer_OptionDlg::OnSize(UINT nType, int cx, int cy)
{
...
void MFC_PicViewer_OptionDlg::OnBnClickedButton101()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_isrestore)
	{
...
void MFC_PicViewer_OptionDlg::OnBnClickedButton102()
{
	// TODO: 在此添加控件通知处理程序代码
...
void MFC_PicViewer_OptionDlg::OnBnClickedButton103()
{
	// TODO: 在此添加控件通知处理程序代码
	CDialog::OnCancel();
}

HBRUSH MFC_PicViewer_OptionDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
